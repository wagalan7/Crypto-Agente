            ...
            <div key={c.id} className="border border-gray-800 rounded-lg overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  <span className="w-6 h-6 rounded-md bg-violet-900/50 border border-violet-800 flex items-center justify-center text-[10px] text-violet-400 font-bold">
                    #{c.id}
                  </span>
                ...
                <div className="border-t border-gray-800 px-4 py-4 space-y-4 bg-gray-900/40">
                  {!detail ? (
                    ...
                    <>
                      ...
                      {/* Agent outputs */}
                      <div className="space-y-2">
                        {Object.entries(detail.result_data).map(([agent, output]) => (
